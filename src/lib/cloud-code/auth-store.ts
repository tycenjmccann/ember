/**
 * Cloud Code — subscription credential store.
 *
 ...
 *
 * Storage:
 *   - Credential bytes → S3 at cloud-code/auth/{userId}/{cli}.json
...
const s3KeyFor = (userId: string, cli: CloudCodeCli) => `cloud-code/auth/${userId}/${cli}.json`;
